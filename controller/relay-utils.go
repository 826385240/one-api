...
func postConsumeQuota(ctx context.Context, tokenId int, quotaDelta int, totalQuota int, userId int, channelId int, modelRatio float64, groupRatio float64, modelName string, tokenName string, request string, reply string, relayMode int, ginContext string) {
	...
	if totalQuota != 0 {
		...
		model.RecordConsumeLog(ctx, userId, channelId, totalQuota, 0, modelName, tokenName, totalQuota, logContent, request, reply, relayMode, ginContext)
